...
-- Create projects table for workspace
...
CREATE POLICY "Admins and developers can insert projects" ON public.projects
...
CREATE POLICY "Admins and developers can update projects" ON public.projects
